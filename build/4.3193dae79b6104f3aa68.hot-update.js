					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 12, md: 8, mdOffset: 2, lg: 8, lgOffset: 2}, 
								React.createElement(bootstrap.Input, {type: "text", ref: "name", value: this.state.name, name: "name", placeholder: "name", onChange: this.handleName, disabled: this.state.disabled, addonBefore: "name  ", hasFeedback: true, required: true, hasFeedback: true}), 

								React.createElement(bootstrap.Input, {type: "text", name: "backup", placeholder: "backup", value: this.state.backup, onChange: this.handleBackup, disabled: this.state.disabled, addonBefore: "backup", hasFeedback: true}), 

								React.createElement(bootstrap.Input, {type: "text", name: "tel", placeholder: "telnum", help: this.state.telError, value: this.state.tel, required: true, onChange: this.handleTel, bsStyle: this.state.telStyle, disabled: this.state.disabled, addonBefore: "telnum", hasFeedback: true}), 
								
								React.createElement(bootstrap.Input, {type: "text", name: "email", placeholder: "email", help: this.state.emailError, value: this.state.email, onChange: this.handleEmail, bsStyle: this.state.emailStyle, disabled: this.state.disabled, addonBefore: "email", hasFeedback: true}), 
								
								React.createElement(bootstrap.Input, {type: "text", name: "qq", placeholder: "QQ", help: this.state.qqError, value: this.state.qq, onChange: this.handleQq, bsStyle: this.state.qqStyle, disabled: this.state.disabled, addonBefore: "qq-num", hasFeedback: true}), 
								
								React.createElement(bootstrap.Input, {type: "text", name: "address", placeholder: "address", value: this.state.address, onChange: this.handleAddress, disabled: this.state.disabled, addonBefore: "address"}), 
