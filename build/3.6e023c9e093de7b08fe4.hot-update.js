				...
				React.createElement("form", {method: "post", action: "#", style: formStyle}, 
				  React.createElement(bootstrap.Row, {className: "show-grid"}, 
						React.createElement(bootstrap.Col, {xs: 10, xsOffset: 1, md: 6, mdOffset: 3}, 
							React.createElement("h1", null, React.createElement("center", null, React.createElement("strong", null, React.createElement("small", null, "登录")))), 
							...
							React.createElement(bootstrap.Button, {bsStyle: "success", style: buttonStyle, type: "submit"}, "登录"), 
