					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 8, xsOffset: 2, md: 6, mdOffset: 3}, 
								...
								React.createElement(bootstrap.Input, {type: "text", name: "tel", placeholder: "手机", value: this.state.tel, required: true, onChange: this.handleTel, bsStyle: this.telState(), hasFeedback: true}), 
								...
								React.createElement(bootstrap.Input, {type: "text", name: "qq", placeholder: "QQ", value: this.state.qq, onChange: this.handleQq, bsStyle: this.qqState(), hasFeedback: true}), 
