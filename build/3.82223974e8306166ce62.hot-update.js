					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 8, xsOffset: 2, md: 6, mdOffset: 3}, 
								React.createElement(bootstrap.Input, {type: "text", value: this.state.name, name: "name", placeholder: "姓名", onChange: this.handleName(), bsStyle: this.validationState(), hasFeedback: true, required: true}), 
