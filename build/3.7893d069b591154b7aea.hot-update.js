					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 8, xsOffset: 2, md: 6, mdOffset: 3}, 
								React.createElement(bootstrap.Input, {type: "text", name: "name", placeholder: "姓名", ref: "name", value: this.state.name, onChange: this.handleName(), bsStyle: this.validationState(), hasFeedback: true, required: true}), 
