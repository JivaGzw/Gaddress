					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 8, xsOffset: 2, md: 6, mdOffset: 3}, 
								...
								React.createElement(bootstrap.Input, {type: "text", name: "email", placeholder: "邮箱", value: this.state.email, onChange: this.handleEmail, bsStyle: this.state.emailStyle}), 
