					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 12, md: 8, mdOffset: 2, lg: 8, lgOffset: 2}, 
								...
								React.createElement(bootstrap.Input, {type: "text", name: "qq", placeholder: "QQ", help: this.state.qqError, value: this.state.qq, onChange: this.handleQq, bsStyle: this.state.qqStyle, disabled: this.state.disabled, addonBefore: "QQ &busp；", hasFeedback: true}), 
