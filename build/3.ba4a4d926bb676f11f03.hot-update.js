					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 8, xsOffset: 2, md: 6, mdOffset: 3}, 
								React.createElement(bootstrap.Input, {type: "text", name: "name", placeholder: "姓名", value: this.state.name, onChange: this.handleName, required: true}), 
								React.createElement(bootstrap.Input, {type: "text", name: "backup", placeholder: "备注", value: this.state.backup}), 
								React.createElement(bootstrap.Input, {type: "text", name: "tel", placeholder: "手机", value: this.state.tel, required: true}), 
								React.createElement(bootstrap.Input, {type: "text", name: "email", placeholder: "邮箱", value: this.state.email}), 
								React.createElement(bootstrap.Input, {type: "text", name: "qq", placeholder: "QQ", value: this.state.qq}), 
								React.createElement(bootstrap.Input, {type: "text", name: "address", placeholder: "住址", value: this.state.address}), 
