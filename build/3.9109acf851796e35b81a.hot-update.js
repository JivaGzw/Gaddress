					...
					React.createElement("form", null, 
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 8, xsOffset: 2, md: 6, mdOffset: 3}, 
								...
								React.createElement(bootstrap.Input, {type: "password", name: "password", placeholder: "备注"}), 
								React.createElement(bootstrap.Input, {type: "text", name: "username", placeholder: "手机", required: true}), 
								React.createElement(bootstrap.Input, {type: "password", name: "password", placeholder: "邮箱"}), 
								React.createElement(bootstrap.Input, {type: "text", name: "username", placeholder: "QQ"}), 
								React.createElement(bootstrap.Input, {type: "password", name: "password", placeholder: "住址"}), 
