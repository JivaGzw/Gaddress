...
/***/ function(module, exports, __webpack_require__) {
		...
		render: function(){
			return (
				React.createElement("div", null, 
					...
					React.createElement(FootText, null)
				)
			);
		}
	});
						...
						React.createElement(bootstrap.Row, {className: "show-grid"}, 
							React.createElement(bootstrap.Col, {xs: 12, md: 8, mdOffset: 2, lg: 8, lgOffset: 2}, 
								...
								React.createElement(bootstrap.ButtonGroup, {justified: true}, 
									React.createElement(bootstrap.Button, {bsStyle: this.state.buttonState, style: buttonStyle, onClick: this.handleButtonEdit}, this.state.buttonText), 
									React.createElement(bootstrap.Button, {bsStyle: "danger", style: buttonStyle, onClick: this.handleButtonDelete}, "Delete")
								)
							)	
						)
					)
	...
	var FootText = React.createClass({displayName: "FootText",
		render: function(){
			return (
				React.createElement("div", null, 
					React.createElement("hr", null), 
					React.createElement("h4", null, React.createElement("center", null, React.createElement("small", null, "A homework and ReactJS demo for Network programming"))), 
					React.createElement("h6", null, React.createElement("center", null, "Powered by GZW"))
				)
			);
		}
	});
