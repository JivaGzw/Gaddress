...
/***/ function(module, exports, __webpack_require__) {
				...
				React.createElement(bootstrap.Navbar, {toggleNavKey: 0}, 
					...
					React.createElement(bootstrap.CollapsibleNav, {eventKey: 0}, 
						React.createElement(bootstrap.Nav, {navbar: true, right: true}, 
							React.createElement(bootstrap.NavItem, {href: "/login", eventKey: 1}, "Login")
						)
					)
				)
			);
	...
	var ContactList = React.createClass({displayName: "ContactList",
		render: function(){
			...
			return (
				React.createElement(bootstrap.ListGroup, {style: ListStyle}, 
					contactNodes
				)
			);
		}
	...
	var Contact = React.createClass({displayName: "Contact",
		render: function(){
			return (
				React.createElement(bootstrap.ListGroupItem, {href: "/people"}, 
					this.props.children, 
			...
			return (
				React.createElement("div", {style: footStyle}, 
					React.createElement("div", {style: centerDiv}, 
						React.createElement(bootstrap.Button, {href: "/people/new", bsSize: "large", bsStyle: "info", style: roundButton}, 
